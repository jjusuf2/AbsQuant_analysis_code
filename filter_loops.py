...
print(f'loaded {len(loops_bedpe)} loops')
...
def run_loop_filtering(k):
    ...
    NaN_pass_T1 = no_NaNs_near_center(coolers['1B1_rep1'], chrom, left, right, convert_coords_function=to_T_coords)
    NaN_pass_T2 = no_NaNs_near_center(coolers['1B1_rep2'], chrom, left, right, convert_coords_function=to_T_coords)
    NaN_pass_T6 = no_NaNs_near_center(coolers['1B1_rep6'], chrom, left, right, convert_coords_function=to_T_coords)
    NaN_pass_T7 = no_NaNs_near_center(coolers['1B1_rep7'], chrom, left, right, convert_coords_function=to_T_coords)
    NaN_pass_C3 = no_NaNs_near_center(coolers['C36_rep1'], chrom, left, right, convert_coords_function=to_C_coords)
    NaN_pass_C4 = no_NaNs_near_center(coolers['C36_rep2'], chrom, left, right, convert_coords_function=to_C_coords)
    NaN_pass_C6 = no_NaNs_near_center(coolers['C36_rep6'], chrom, left, right, convert_coords_function=to_C_coords)
    NaN_pass_C7 = no_NaNs_near_center(coolers['C36_rep7'], chrom, left, right, convert_coords_function=to_C_coords)
    NaN_pass_all_merged = no_NaNs_near_center(coolers['all_merged'], chrom, left, right)

    passed_step_1 = np.all([size_loc_pass, NaN_pass_T1, NaN_pass_T2, NaN_pass_T6, NaN_pass_T7, NaN_pass_C3, NaN_pass_C4, NaN_pass_C6, NaN_pass_C7, NaN_pass_all_merged])

    if not passed_step_1:
        return size_loc_pass, NaN_pass_T1, NaN_pass_T2, NaN_pass_T6, NaN_pass_T7, NaN_pass_C3, NaN_pass_C4, NaN_pass_C6, NaN_pass_C7, NaN_pass_all_merged, None, None, None, None, None, None, None, None, None

    read_counts_per_pixel_T1 = read_counts_per_pixel(coolers['1B1_rep1'], chrom, left, right, convert_coords_function=to_T_coords)
    read_counts_per_pixel_T2 = read_counts_per_pixel(coolers['1B1_rep2'], chrom, left, right, convert_coords_function=to_T_coords)
    read_counts_per_pixel_T6 = read_counts_per_pixel(coolers['1B1_rep6'], chrom, left, right, convert_coords_function=to_T_coords)
    read_counts_per_pixel_T7 = read_counts_per_pixel(coolers['1B1_rep7'], chrom, left, right, convert_coords_function=to_T_coords)
    read_counts_per_pixel_C3 = read_counts_per_pixel(coolers['C36_rep1'], chrom, left, right, convert_coords_function=to_C_coords)
    read_counts_per_pixel_C4 = read_counts_per_pixel(coolers['C36_rep2'], chrom, left, right, convert_coords_function=to_C_coords)
    read_counts_per_pixel_C6 = read_counts_per_pixel(coolers['C36_rep6'], chrom, left, right, convert_coords_function=to_C_coords)
    read_counts_per_pixel_C7 = read_counts_per_pixel(coolers['C36_rep7'], chrom, left, right, convert_coords_function=to_C_coords)

    passed_step_2 = np.mean([read_counts_per_pixel_T1, read_counts_per_pixel_T2, read_counts_per_pixel_T6, read_counts_per_pixel_T7,
                             read_counts_per_pixel_C3, read_counts_per_pixel_C4, read_counts_per_pixel_C6, read_counts_per_pixel_C7]) > min_read_counts_per_pixel

    if not passed_step_2:
        return size_loc_pass, NaN_pass_T1, NaN_pass_T2, NaN_pass_T6, NaN_pass_T7, NaN_pass_C3, NaN_pass_C4, NaN_pass_C6, NaN_pass_C7, NaN_pass_all_merged, read_counts_per_pixel_T1, read_counts_per_pixel_T2, read_counts_per_pixel_T6, read_counts_per_pixel_T7, read_counts_per_pixel_C3, read_counts_per_pixel_C4, read_counts_per_pixel_C6, read_counts_per_pixel_C7, None
    ...
    return size_loc_pass, NaN_pass_T1, NaN_pass_T2, NaN_pass_T6, NaN_pass_T7, NaN_pass_C3, NaN_pass_C4, NaN_pass_C6, NaN_pass_C7, NaN_pass_all_merged, read_counts_per_pixel_T1, read_counts_per_pixel_T2, read_counts_per_pixel_T6, read_counts_per_pixel_T7, read_counts_per_pixel_C3, read_counts_per_pixel_C4, read_counts_per_pixel_C6, read_counts_per_pixel_C7, global_max_dist_all_merged

# initialize dataframe for storing results
loop_filtering_criteria_df = pd.DataFrame(index=loops_df.index, columns=['size_loc_pass','NaN_pass_T1','NaN_pass_T2','NaN_pass_T6','NaN_pass_T7','NaN_pass_C3','NaN_pass_C4','NaN_pass_C6','NaN_pass_C7','NaN_pass_all_merged','read_counts_per_pixel_T1','read_counts_per_pixel_T2','read_counts_per_pixel_T6','read_counts_per_pixel_T7','read_counts_per_pixel_C3','read_counts_per_pixel_C4','read_counts_per_pixel_C6','read_counts_per_pixel_C7','global_max_dist_all_merged'])
